...
def generate_certificate():
    ...
    try:
        ...
        # Get instructor name from course data (it's stored as a string in sample data)
        instructor_name = course.get('instructor', 'Instructor')
